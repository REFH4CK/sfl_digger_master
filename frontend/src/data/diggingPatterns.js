...
export const DIGGING_FORMATIONS = {
  ...
  FRIDAY_ARTEFACT_FORMATION: [
    ...
    { x: 3, y: 0, name: SEASONAL_ARTEFACT },
  ],
  ...
  SUNDAY_ARTEFACT_FORMATION: [
    { x: 0, y: -2, name: SEASONAL_ARTEFACT },
  ],

  ARTEFACT_ONE: [
    { x: 0, y: 0, name: SEASONAL_ARTEFACT },
    { x: 0, y: 1, name: "Camel Bone" },
  ...
  ARTEFACT_THREE: [{ x: 0, y: 0, name: SEASONAL_ARTEFACT }],
  ...
  ARTEFACT_TWENTY: [
    { x: 0, y: 0, name: "Camel Bone" },
    { x: 1, y: 0, name: "Camel Bone" },
    { x: 0, y: 1, name: SEASONAL_ARTEFACT },
    { x: 1, y: 1, name: "Camel Bone" },
  ],
  ...
  ARTEFACT_TWENTY_THREE: [
    ...
    { x: 2, y: 0, name: "Camel Bone" },
    { x: 1, y: 1, name: "Camel Bone" },
    { x: 2, y: 1, name: SEASONAL_ARTEFACT },
  ],
